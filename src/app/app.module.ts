...
import { EditValuesInConfigDialogComponent } from './dialogs/edit-values-in-config-dialog/edit-values-in-config-dialog.component';
...
@NgModule({
    declarations: [
        ...
        EditValuesInConfigDialogComponent,
